...
public:
    ...
    void              notify(uint16_t currentActiveDevice = 0, bool is_notification = true);
    void notify(const uint8_t* value, size_t length,
                uint16_t currentActiveDevice = 0, bool is_notification = true);
